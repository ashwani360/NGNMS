...
public class DataReader {
	...
	public static Object[][] hubreader1() throws IOException
	{
		
		 FileInputStream file = new FileInputStream(new File("src\\Data\\HubData.xlsx"));
		 XSSFWorkbook workbook = new XSSFWorkbook(file);
		 XSSFSheet sheet = workbook.getSheetAt(0);
		 XSSFRow r1=sheet.getRow(0);
		 XSSFRow r;
...
//	}
	...
	System.out.println(hubreader1().length);
}
//	
}